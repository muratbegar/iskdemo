...
namespace ELearningIskoop.Courses.Infrastructure.Migrations
{
    ...
    [Migration("20250811073815_Mg_005")]
    partial class Mg_005
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ELearningIskoop.Courses.Domain.Entities.Course", b =>
                {
                    b.OwnsOne("ELearningIskoop.Shared.Domain.ValueObjects.Duration", "TotalDuration", b1 =>
                        {
                            b1.Property<int>("CourseObjectId")
                                .HasColumnType("integer");
                            ...
                            b1.HasKey("CourseObjectId");

                            b1.ToTable("Courses", "courses");

                            b1.WithOwner()
                                .HasForeignKey("CourseObjectId");
                        });

                    b.OwnsOne("ELearningIskoop.Shared.Domain.ValueObjects.Email", "InstructorEmail", b1 =>
                        {
                            b1.Property<int>("CourseObjectId")
                                .HasColumnType("integer");
                    ...
                    b.OwnsOne("ELearningIskoop.Shared.Domain.ValueObjects.Money", "Price", b1 =>
                        {
                            b1.Property<int>("CourseObjectId")
                                .HasColumnType("integer");
                    ...
                    b.OwnsOne("ELearningIskoop.Shared.Domain.ValueObjects.PersonName", "InstructorName", b1 =>
                        {
                            b1.Property<int>("CourseObjectId")
                                .HasColumnType("integer");

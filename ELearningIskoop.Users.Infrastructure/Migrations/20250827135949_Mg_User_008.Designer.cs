...
namespace ELearningIskoop.Users.Infrastructure.Migrations
{
    ...
    [Migration("20250827135949_Mg_User_008")]
    partial class Mg_User_008
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ELearningIskoop.Users.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<int>("ObjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ELearningIskoop.Users.Domain.Entities.Permission", b =>
                {
                    ...
                    b.HasOne("ELearningIskoop.Users.Domain.Entities.Role", null)
                        .WithMany("Permissions")
                        .HasForeignKey("RoleObjectId");

                    b.OwnsOne("ELearningIskoop.Users.Domain.ValueObjects.Permissions.PermissionValue", "PermissionValue", b1 =>
                        {
                            b1.Property<int>("PermissionObjectId")
                                .HasColumnType("integer");
                            ...
                            b1.HasKey("PermissionObjectId");

                            b1.ToTable("Permissions", "users");

                            b1.WithOwner()
                                .HasForeignKey("PermissionObjectId");
                        });
